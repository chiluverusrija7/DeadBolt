...
$(DEADBOLT): src/deadbolt.c src/parser.c src/executor.c src/signals.c include/parser.h include/executor.h include/signals.h
	$(CC) $(CFLAGS) $(INCLUDES) src/deadbolt.c src/parser.c src/executor.c src/signals.c -o $(DEADBOLT)
...
$(EXECUTOR_TEST): src/parser.c src/executor.c src/signals.c src/executor_test.c include/parser.h include/executor.h include/signals.h
	$(CC) $(CFLAGS) $(INCLUDES) src/parser.c src/executor.c src/signals.c src/executor_test.c -o $(EXECUTOR_TEST)
